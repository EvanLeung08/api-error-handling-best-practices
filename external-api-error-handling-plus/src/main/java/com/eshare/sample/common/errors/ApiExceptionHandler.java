...
public class ApiExceptionHandler {
   ...
   * instance of {@linkplain ErrorResponse} with appropriate and localized message will return to
   * the client. {@linkplain ErrorCode} itself determines the HTTP status of the response.
   *
  ...
  ResponseEntity<ErrorResponse> handleServiceExceptions(FacadeException exception, Locale locale) {
  ...
  public ResponseEntity<ErrorResponse> handleValidationExceptions(
    ...
    return ResponseEntity
        .badRequest().body(ErrorResponse
            .ofErrors(MDC.get(HttpAttributeConsts.TRACE_ID), HttpStatus.BAD_REQUEST, apiErrors));
  }
